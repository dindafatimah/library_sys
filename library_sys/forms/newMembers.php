...
<head>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="content">
            ...
            <form action="../process/members-input.php" method="POST" enctype="multipart/form-data" class="was-validated">

            <tr>
            <div class="col-auto">
                <label for="validationTextarea" class="form-label" style="float: left; font-weight: bolder; color: black; font-size: 20px;">Name</label>
                <input type="text" class="form-control is-invalid" id="validationTextarea" name="name" placeholder="Name" required></input>
                ...
                <input type="email" class="form-control is-invalid" id="validationTextarea" name="email" placeholder="youremail@mail.com" required></input>
                <div class="invalid-feedback">
                This field cannot be empty.
                </div>
                <br />
                ...
                <input type="text" class="form-control is-invalid" id="validationTextarea" name="domicile" placeholder="Domicile" required></input>
                <div class="invalid-feedback">
                This field cannot be empty.
                </div>
                <br />
                ...
                <div class="mb-3">
                <button name="save" value="save" class="btn" type="submit" onclick = "return confirm ('Is all the data correct?')">Sign Up</button>
            </div>
            </div>
        </div>
    </div>

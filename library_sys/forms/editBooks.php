<?php
	...
	// query data
    $result = $pdo->query("SELECT id, title, isbn, author, genre_id
    FROM books
    WHERE id = " .$id);
...
<head>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <h1>Edit <?php echo $row['title']; ?>'s Details</h1>
    ...
    <div class="content">
            ...
            <form action="../process/books-update.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data" class="was-validated">
            ...
            <div class="col-auto">
                ...
                <input type="text" class="form-control is-invalid" id="validationTextarea" name="title" value="<?php echo $row['title']; ?>" required></input>
                ...
                <input type="number" class="form-control is-invalid" id="validationTextarea" name="isbn" value="<?php echo $row['isbn']; ?>" required></input>
                <div class="invalid-feedback">
                This field cannot be empty.
                </div>
                <br />
                ...
                <input type="text" class="form-control is-invalid" id="validationTextarea" name="author" value="<?php echo $row['author']; ?>" required></input>
                <div class="invalid-feedback">
                This field cannot be empty.
                </div>
                <br />
                ...
                <div>
                <select id="genre" name="genre_id" class="custom-select" required>
                    ...
                    <?php if($res['id']==$row['genre_id']) echo "selected"; ?>><?php echo $res['name']; ?>
                    </option>
                ...
                <p>  </p>
                <a class="btn-delete" href="../process/books-delete.php?id=<?php echo $id?>" onclick = "return confirm ('Are you sure?')">Delete</a>
            </div>
            </div>
        </div>
    </div>

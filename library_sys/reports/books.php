...
include'../db_connect.php';
    ...
    ORDER BY books.title DESC, books.isbn DESC");
?>
...
<head>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="content">
	    ...
	    <a href="../prints/books.php" target="_blank" style="font-size: large">Print Table</a>
        <br />
        <br />
        <a class="btn" href="../CRUD/books.php" style="font-size: larger">Edit Books Details</a>
    </div>
    <br />
    <br />

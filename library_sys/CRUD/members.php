...
<head>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="content">
	    ...
	    <a href="../reports/members.php" style="font-size: large">See Report</a>
        <br />
        <br />
        <a class="btn" href="../forms/newMembers.php" style="font-size: larger">Add New Data</a>
    </div>
    <br />
    <br />
    ...
    <div class="d.flex justify-content-center" >
        ...
        <?php while($row = $result->fetch(\PDO::FETCH_ASSOC)):?>
				<tr>
                    ...
                    <td>
                        <a class="btn"href="../forms/editMembers.php?id=<?php echo $row['id'];?>">Edit</a>
                        <a class="btn"target="_blank" href="../prints/membership.php?id=<?php echo $row['id'];?>" style="background-color: #50ACAC;">Print Card</a></div>
                    </td>
                    <?php endwhile;?>			
		        </tr>

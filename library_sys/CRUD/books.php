...
<head>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="content">
        <h1>Books Collection Data</h1>
	    <a href="../reports/books.php" style="font-size: large">See Report</a>
        <br />
        <br />
        <a class="btn" href="../forms/newBooks.php" style="font-size: larger">Add New Data</a>
    </div>
    <br />
    <br />
    ...
    <div class="d.flex justify-content-center" >
        ...
        <?php while($row = $result->fetch(\PDO::FETCH_ASSOC)):?>
				<tr>
                    ...
                    <td>
                        <a class="btn" href="../forms/editBooks.php?id=<?php echo $row['id'];?>">Edit</a>
                    </td>
                    <?php endwhile;?>			
		        </tr>
